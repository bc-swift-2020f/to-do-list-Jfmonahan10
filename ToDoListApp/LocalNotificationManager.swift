        ...
        UNUserNotificationCenter.current().requestAuthorization(options: [.alert, .sound, .badge]) { (granted, error) in
            ...
            if granted {
                ...
                DispatchQueue.main.async {
                    viewController.oneButtonAlert(title: "User Has Not Allowed Notifications", message: "To Receive alerts for reminders, open the settings app, select To Do List > Notifcations > Allow Notifications ")
                }
            }
        }
    }
